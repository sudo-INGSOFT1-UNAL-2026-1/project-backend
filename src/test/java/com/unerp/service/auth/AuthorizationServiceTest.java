...
public class AuthorizationServiceTest {
    ...
    @Mock
    private RolePermissionReadRepository rolePermissionReadRepository;
    ...
    public void shouldValidatePermissionSuccessfully() {
        ...
        when(rolePermissionReadRepository
                .existsByRole_IdAndPermission_name(1, "GESTION_ROLES")).thenReturn(true);
    ...
    public void shouldThrowExceptionWhenPermissionIsMissing() {
        ...
        when(rolePermissionReadRepository
                .existsByRole_IdAndPermission_name(1, "GESTION_ROLES")).thenReturn(false);
